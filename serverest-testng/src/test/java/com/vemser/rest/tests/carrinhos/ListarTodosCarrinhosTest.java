...
public class ListarTodosCarrinhosTest {
	...
	@Test(description = "CT-001: Deve validar contrato de listar todos os carrinhos com sucesso")
	...
	@Test(description = "CT-002: Deve retornar 200 quando listar todos os carrinhos com sucesso")
