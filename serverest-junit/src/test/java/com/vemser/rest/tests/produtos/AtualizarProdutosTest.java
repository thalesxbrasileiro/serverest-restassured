...
public class AtualizarProdutosTest {
	...
	@Order(1)
	@Test
	@DisplayName("CT-001: Deve retornar 200 ao atualizar produto com sucesso")
	...
	@Order(4)
	@Test
	@DisplayName("CT-004: Deve retornar 400 ao tentar atualizar produto sem informar descrição")
	...
	@Order(3)
	@Test
	@DisplayName("CT-003: Deve retornar 401 ao tentar atualizar produto sem estar autenticado")
	...
	@Order(2)
	@Test
	@DisplayName("CT-002: Deve retornar 403 ao tentar atualizar produto sem ser administrador")
